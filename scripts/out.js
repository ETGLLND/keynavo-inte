(() => {
  ...
  // scripts/modules/reviews.js
  var require_reviews = __commonJS({
    "scripts/modules/reviews.js"() {
      var reviewsRoot = document.querySelector(".reviews-bloc");
      var prevBtn = reviewsRoot.querySelector(".controls > .left");
      var nextBtn = reviewsRoot.querySelector(".controls > .right");
      var swiperContainer = reviewsRoot.querySelector(".swiper");
      var swiper = new Swiper(swiperContainer, {
        ...
        slidesPerView: "auto",
        // Ajuste la largeur des slides
        centeredSlides: true,
        // Centre le groupe de slides
        loop: true,
        spaceBetween: 70
      });
    }
  ...
  Swiper2.use([Resize, Observer2]);

  // scripts/main.js
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  var createOpenAnimation = (container, basisClass, adjustment = 0, target = container, nav = false) => {
    ...
    target.addEventListener("click", (e) => {
      if (!opened) {
        ...
        if (nav) {
          container.style.maxHeight = `${container.scrollHeight + adjustment + 100}px`;
        } else {
  ...
  var changeSwiperDots = (swiper, dots) => {
  ...
  var activateSliderDots = (triggers, swiper) => {
  ...
  if (document.querySelector(".reviews-bloc")) {
    Promise.resolve().then(() => __toESM(require_reviews()));
  }
  var titleRoot = document.querySelector(".title-scroll");
  if (titleRoot) {
  ...
  var faqRoot = document.querySelector(".faq-bloc");
  if (faqRoot) {
  ...
  var navRoot = document.querySelector("nav.navigation");
  if (navRoot) {
  ...
  var twoRoots = document.querySelectorAll(".two-columns");
  if (twoRoots) {
    twoRoots.forEach((twoRoot) => {
      ...
      const swiper = new Swiper2(swiperContainer, {
        slidesPerView: "auto",
        // Ajuste la largeur des slides
        navigation: {
          prevEl: prevBtn,
  ...
  var partnersRoot = document.querySelector(".partners");
  if (partnersRoot) {
  ...
  var timelineRoot = document.querySelector(".timeline-v1-alt");
  if (timelineRoot) {
  ...
  var timelineV1 = document.querySelector(".timeline-v1");
  if (timelineV1) {
  ...
  var heroRoot = document.querySelector(".hero-section-v1");
  if (heroRoot) {
  ...
  var heros = document.querySelectorAll(".hero-section");
  heros.forEach((hero) => {
    const container = hero.querySelector(".shrink-container");
    const computedWidth = window.innerWidth > 769 ? window.innerWidth - 330 : window.innerWidth - 80;
  ...
  var nestedBlocks = document.querySelectorAll(".nested-blocks");
  if (nestedBlocks) {
  ...
  var calculatorRoot = document.querySelector(".calculator-v1");
  if (calculatorRoot) {
    ...
    const changeValues = (price) => {
      ...
      let finalValueMin = (smartDigitValue - smartKeynavo2Value).toFixed(1) > 0 ? (smartDigitValue - smartKeynavo2Value).toFixed(1) : 0;
      let finalValueMax = (smartTradValue - smartKeynavo2Value).toFixed(1) > 0 ? (smartTradValue - smartKeynavo2Value).toFixed(1) : 0;
      smartResult.innerHTML = `${parseFloat(finalValueMin)}\u20AC \xE0 ${parseFloat(
        finalValueMax
      )}\u20AC / an`;
    };
  ...
  var tabsSwitchRoot = document.querySelector(".tabs-switch");
  if (tabsSwitchRoot) {
    ...
    tabs.forEach((tab, id) => {
      tab.addEventListener("click", (e) => {
        ...
        containers.forEach((container, idContainer) => {
          id === idContainer ? container.classList.add("open") : container.classList.remove("open");
        });
      });
    });
  }
  var identityRoot = document.querySelector(".identity");
  if (identityRoot) {
    if (window.innerWidth <= 576) {
  ...
  var choiceRoot = document.querySelector(".choice-form");
  if (choiceRoot) {
      ...
      btn.addEventListener("click", (e) => {
        ...
        if (btn.dataset.city === "rennes") {
          nextBtnClone.addEventListener(
            "click",
            (e2) => document.location.href = redirect
          );
        } else if (btn.dataset.city === "other") {
          nextBtnClone.addEventListener("click", (e2) => swiper.slideNext());
        } else if (btn.dataset.city === "client") {
          nextBtnClone.addEventListener("click", (e2) => swiper.slideNext());
        } else if (btn.dataset.city === "new") {
          nextBtnClone.addEventListener("click", (e2) => swiper.slideTo(2));
        }
  ...
  var packRoot = document.querySelector(".packs");
  if (packRoot) {
